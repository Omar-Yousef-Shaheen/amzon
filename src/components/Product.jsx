...
const Product = ({ id, image, price, rating, title }) => {
  ...
  return (
    <div className="rounded-md bg-white py-8 p-4 my-4 cursor-pointer hover:bg-gray-400 hover:text-white transition-all duration-200 ">
      ...
      <div className="flex flex-col   items-center gap-8">
        <img
          className="max-w-[40%]   h-40  cursor-pointer hover:scale-[1.1] transition-all duration-300"
          src={image}
          alt="Photo-Image"
        />
        {user?.email && (
